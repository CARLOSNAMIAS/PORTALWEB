const heroStory = {
    ...
    location: 'Bogotá',
    comments: 156,
    url: 'articles/nueva-reforma-educativa.html'
};
...
const topStories = [
    ...
    },
    {
        ...
        time: 'Hace 4 horas',
        reads: '2.1k lecturas',
        url: 'articles/economia-colombiana.html'
    },
    {
        image: 'img/IA.jpg',
        ...
        time: 'Hace 8 horas',
        reads: '3.2k lecturas',
        url: 'articles/avances-ia-medicina.html'
    }
];
...
const trendingStories = [
    {
        ...
        url: 'articles/placeholder-article.html' // URL de ejemplo
    },
    {
        rank: 2,
        title: 'Medicina regenerativa ofrece nueva esperanza',
        meta: 'Hace 3 horas • 4.8k lecturas',
        url: 'articles/placeholder-article.html'
    },
    {
        rank: 3,
